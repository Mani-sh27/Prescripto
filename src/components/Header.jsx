        ...
        <div className='flex justify-between bg-blue-400 mx-28 h-[450px] mt-6 rounded-lg'>
            <div>
                ...
                <div className='flex flex-col gap-28 mt-4'>
                    ...
                    <a className='relative -top-20 left-24 p-2.5 ps-2 rounded-full text-xl bg-white w-56' href="">Book Appointment<img className='relative left-44 -top-4.5 ' src={assets.arrow_icon} /></a>
                </div>
            </div>
