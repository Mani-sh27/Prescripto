  ...
  return (
    <div className='flex w-min-80 bg-[#5f6fff] rounded-xl mx-42 mt-4 h-[500px] '>
      <section className=''>
        ...
        <button className='sm:bg-[white] px-10  py-2 rounded-full' type='button'>Book appointment</button>
      ...
      <section>
        <img src={assets.header_img} className='sm:relative w-[500px] left-25 top-20   ' />
      </section>
    </div>
  )
}
