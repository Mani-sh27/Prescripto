...
const Header = () => {
  return (
    <div className=' max-w-[1200px] w-full flex-row relative -left-7 h-[1230px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[500px]'>
      <section >
        ...
        <button className='   bg-white left-20 relative  text-2xl sm:text-base sm:ps-10 sm:py-3 sm:-ms-20 sm:bg-[white] px-20 ps-15 py-4 rounded-full' type='button'>Book appointment</button>
        <img src={assets.arrow_icon} className=' relative left-87 w-6 -top-8 p-5 sm:w-4  sm:relative sm:top-0 cursor-pointer sm:-left-8'  />
        </div>

      </section>
      <section> 
        <img src={assets.header_img} className='w-[970px] relative top-43 -left-1   sm:w-[500px] sm:top-23  sm:relative sm:left-16' />
      </section>
    </div>
  )
}
