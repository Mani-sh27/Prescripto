...
const Header = () => {
  return (
    <div className='flex justify-between bg-[#5f6fff] sm:w-3xl mx-28 h-[450px] mt-6 rounded-lg 
      ...
      <div className='flex-1 text-center md:text-left'>
        ...
        <div className='flex flex-col gap-28 mt-4 items-center md:items-start'>
          <img
            className='relative top-40 w-24 ms-16 mt-5 top-8 md:top-40 ms-0 md:ms-16'
          ...
          <a
            className='relative pt-2 ps-6 -pt-4 rounded-full bg-white w-56 
          ...
          >
            Book Appointment
            <img
              className='relative  -top-4.5 left-0 md:left-38 md:-top-4.5 mx-auto md:mx-0'
