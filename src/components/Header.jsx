...
const Header = () => {
  return (
    <div className='flex justify-between lg:w-7xl bg-[#5f6fff] sm:flex w-5xl mt-6 rounded-lg 
      ...
      <div className='flex-1 text-center md:text-left'>
        ...
        <div className='flex flex-col gap-28 mt-4 items-center md:items-start'>
          <img
            className='md:relative top-40 w-24 ms-16 mt-5 sm:flex relative top-0'
