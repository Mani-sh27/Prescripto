...
const Header = () => {
  return (
    <div className=' min-w-[1000px] flex-row relative -left-12 h-[1500px] sm:flex bg-[#5f6fff] mx-42 mt-4 rounded-xl md:h-auto '>
      <section>
        ...
        <div className='sm:flex relative top-38 text-white left-20'>
          <img src={assets.group_profiles} className='sm:flex relative -top-9 left-66 w-44' />
      ...
      <section>
        <img src={assets.header_img} className='w-[970px] relative top-45 -left-1 sm:w-[600px] mt-5 sm:relative sm:left-4' />
      </section>
    </div>
  )
}
