    ...
    <div className=' min-w-[900px] flex-row relative -left-7 h-[1500px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[500px]'>
      <section >
        ...
        <div className='sm:flex relative top-40 left-20'>
          <img src={assets.group_profiles} className='ms-56 w-52  sm:relative left- sm:w-30' />
          <p className='  text-white text-2xl mt-4 sm:text-sm me-20 sm:text-white relative'>Simply browse through our extensive list of trusted doctors,<br />
