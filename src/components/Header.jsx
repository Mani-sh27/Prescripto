...
const Header = () => {
  return (
    <div className=' min-w-[900px] flex-row relative -left-7 h-[1500px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[300px]'>
      <section >
        ...
        <button className=' ms-30 bg-white text-2xl sm:text-base sm:bg-[white] px-10 ps-5 py-2 rounded-full' type='button'>Book appointment</button>
        <img src={assets.arrow_icon} className=' relative left-70 -top-6.5   sm:w-4  sm:relative sm:top-0 cursor-pointer sm:-left-8'  />
        </div>
