        ...
        <div className='flex justify-between bg-blue-400 mx-28 h-[450px] mt-6 rounded-lg'>
            <div>
                ...
                <div className='flex flex-col gap-28 mt-4'>
                    ...
                    <a className='relative -top-24 left-24 pt-2 ps-6 -pt-4 rounded-full  bg-white w-56 transition-all hover: translate-y-2 duration-300' href="">Book Appointment<img className='relative left-38 -top-4.5 ' src={assets.arrow_icon} /></a>
                </div>
            </div>
