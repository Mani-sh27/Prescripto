  ...
  return (
    <div className=' min-w-[900px] flex-row relative -left-7 h-[1230px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[500px]'>
      <section >
        ...
        <button className=' ms-30  bg-white left-20 relative ps-5 text-2xl sm:text-base sm:ps-10 sm:py-3 sm:-ms-0 sm:bg-[white] px-20 ps-5 py-4 rounded-full' type='button'>Book appointment</button>
