    ...
    <div className=' min-w-[900px] flex-row relative -left-7 h-[1500px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[500px]'>
      <section >
        ...
        <div className='sm:flex relative top-40 left-20'>
          ...
          <p className='text-white text-2xl mt-6 ms-16 sm:text-sm me-20 sm:text-white relative'>Simply browse through our extensive list of trusted doctors,<br />
            schedule your appointment hassle-free.</p>
        </div>
        <div className='sm:flex relative left-20 top-48'> 
        <button className='bg-white text-3xl ms-52 sm:bg-[white] px-10 ps-5 py-2 rounded-full' type='button'>Book appointment</button>
        <img src={assets.arrow_icon} className=' relative left-10 sm:static sm:relative sm:w-4 cursor-pointer sm:-left-8'  />
        </div>
