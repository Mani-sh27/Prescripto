...
const Header = () => {
  return (
    <div className=' min-w-[900px] flex-row relative -left-12 h-[1500px] sm:flex sm:h- bg-[#5f6fff] mx-42 mt-4 rounded-xl md:h-auto '>
      <section >
      ...
      <section> 
        <img src={assets.header_img} className='w-[970px] relative top-45 -left-1 sm:w-[600px] -mt-[210px]  sm:relative sm:left-4' />
      </section>
    </div>
  )
}
