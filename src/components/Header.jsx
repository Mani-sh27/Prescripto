...
const Header = () => {
  return (
    <div className=' min-w-[900px] flex-row relative -left-12 h-[1000px] sm:flex bg-[#5f6fff] mx-42 mt-4 rounded-xl md:h-auto '>
      <section>
      ...
      <section>
        <img src={assets.header_img} className='w-[840px] relative sm:w-[600px] mt-5 relative left-4' />
      </section>
    </div>
  )
}
