        ...
        <div className='flex justify-between bg-blue-400 mx-28 h-[450px] mt-6 rounded-lg'>
            <div>
                ...
                <div className='flex flex-col gap-28 mt-4'>
                    ...
                    <a className='relative -top-24 left-24 p-2 ps-4 pt-4 rounded-full  bg-white w-56 hover:transition-all translate-y-4 duration-300' href="">Book Appointment<img className='relative left-40 -top-4.5 ' src={assets.arrow_icon} /></a>
                </div>
            </div>
