...
const Header = () => {
  return (
    <div className='flex justify-between lg:w-7xl bg-[#5f6fff] mx-28 h-[450px] mt-6 rounded-lg 
      ...
      <div className='flex-1 text-center md:text-left'>
        ...
        <div className='flex flex-col gap-28 mt-4 items-center md:items-start'>
          ...
          >
            Book Appointment
            <img
              className='relative left-38 -top-4.5 left-0 md:left-38 md:-top-4.5 mx-auto md:mx-0'
