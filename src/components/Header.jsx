...
const Header = () => {
  return (
    <div className=' min-w-[900px] flex-row relative -left-12 h-[1500px] sm:flex  bg-[#5f6fff] mx-36 sm:relative sm:-left-6 mt-4 rounded-xl sm:h-[500px]'>
      <section >
        ...
        <div className='relative left-20 top-38  sm:flex sm:text-white'>
          <img src={assets.group_profiles} className='relative  sm:w-[90px]' />
        ...
        <img src={assets.arrow_icon} className='sm:relative size-2-left-7'  />
        </div>
