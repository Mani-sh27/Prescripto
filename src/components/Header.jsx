...
const Header = () => {
  return (
    <div className='lg:flex-row sm:flex flex-col bg-[#5f6fff] rounded-xl mx-42 mt-4  '>
      <section className=''>
        ...
        <button className='mt-4 sm:bg-[white] px-10 ps-5 py-2 rounded-full' type='button'>Book appointment</button>
