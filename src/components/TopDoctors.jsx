      ...
      <div className='grid w-full grid-cols-auto'>
        {
          doctors.slice(0, 10).map((item, index) => (
            <div className=' size-50  mx-auto  cursor-pointer  hover:-translate-y-2 duration-500 transition-all'>
              <img className='bg-blue-50  rounded-2xl border-blue-50' src={item.image} alt="" />
              <div>
