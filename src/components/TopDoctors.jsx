...
const Doctors = () => {
  return (
    <div>
      <p className='text-center mt-30 text-5xl ms-74 font-semibold '>Top Doctors</p>
      <p className='text-center mt-4 ms-62'>Simply browse through our extensive list of trusted doctors.</p>
