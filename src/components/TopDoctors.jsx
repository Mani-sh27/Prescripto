      ...
      <div className='grid w-full grid-cols-auto'>
        {
          doctors.slice(0, 10).map((item, index) => (
            <div className='  mt-16 ms-10 me-40  w-64 cursor-pointer border-blue-50 border-3 rounded-2xl hover:-translate-y-2 duration-500 transition-all'>
              <img className='bg-blue-50  rounded-t2xl ' src={item.image} alt="" />
              <div>
