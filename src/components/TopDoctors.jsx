      ...
      <div className='grid w-full grid-cols-auto'>
        {
          doctors.slice(0, 10).map((item, index) => (
            <div className='  mt-16 ms-10 me-64  w-60 mx-auto cursor-pointer border-blue-100 border-2 rounded-2xl hover:-translate-y-2 duration-500 transition-all'>
              <img className='bg-blue-50  rounded-t-2xl gap-4' src={item.image} alt="" />
              <div>
