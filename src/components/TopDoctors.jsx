...
const TopDoctors = () => {
  ...
  return (
    <div>
      ...
      <div className='lg:grid grid-cols-auto sm: '>
        {
          doctors.slice(0, 10).map((item, index) => (
            <div className='p-6'>
              <div className='mt-6 w-68 sm:flex min-w-[700px] cursor-pointer border-blue-100 border-2 rounded-2xl hover:-translate-y-2 duration-500 transition-all'>
