      ...
      <div className='flex justify-between mx-42 ms-30 pb-4 border-b-[0.1px] sm:flex min-w-[890px]    '>
        ...
        <div>
          <ul className='mt-10 gap-10 ms-16 sm:flex hidden'>
            ...
            <div className='flex relative grou['>
              {
                token ? <div className='w-9  flex -top-3 relative'>
                  ...
                  <div className='absolute top-0 right-0 pt-14  w-[200px] hidden group-hover:block'>
                    <div className='bg-gray-100 px-8 py-4 leading-7 z-10'>
                      <ul className='-ms-4'>
                        ...
                        <p onClick={()=>navigate()} className='cursor-pointer'>My-Appointments</p>
                  ...
                  <button type='button' className='border  cursor-pointer -mt-5 px-5 bg-blue-500 text-white py-2 rounded-full ms-10'>Create account</button>
                </div>
              }
