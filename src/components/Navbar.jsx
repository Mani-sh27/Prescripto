        ...
        <div>
          <ul className='flex mt-10 gap-10 ms-28'>
            ...
            <NavLink className={({isActive})=>`pb-1${isActive ? ' border-b-2' : ''}`} to='/contact'>
             ...
             <NavLink to='/admin'>
              <li className='border px-3 py-1 rounded-full -mt-1 font-semibold text-xs'>Admin Panel</li>
            </NavLink>
          </ul>
        </div>
        <div>
          <button type='button' className='border cursor-pointer mt-7 px-5 bg-blue-500 text-white py-2 rounded-full ms-4'>Create account</button>
        </div>
        <div>
