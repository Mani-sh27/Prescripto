  ...
  return (
    <div>
      <section>
          ...
          <p className='sm:relative left-20 overflow-hidden '>Simply browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</p>
      </section>
