  ...
  return (
    <div>
      <section className=' relative top-16 sm:relative sm:top-4'>
          <p className=' sm:ms-0 text-center relative left-48  text-5xl  sm:relative top-10  sm:text-3xl font-semibold '>Find by Speciality</p>
       ...
       <section id='Speciality' className=' flex justify-center sm:flex gap-5 sm:justify-center mt-30 text-center'>
