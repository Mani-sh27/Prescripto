  ...
  return (
    <div>
      <section className=' relative top-16 sm:relative sm:top-4'>
          ...
          <p className=' sm:relative text-center text-sm left-[580px]  mt-10  top-20  '>Simply browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</p>
      </section>
