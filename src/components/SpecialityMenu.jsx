  ...
  return (
    <div>
      <section className=' relative top-16 sm:relative sm:top-4'>
       ...
       <section id='Speciality' className=' overflow-x-scroll relative top-12 left-60 flex justify-center sm:flex sm:relative sm:-left-1 gap-5 sm:justify-center mt-10 text-center'>
