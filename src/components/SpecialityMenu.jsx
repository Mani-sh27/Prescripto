  ...
  return (
    <div>
      <section className=' relative top-16 sm:relative sm:top-4'>
          ...
          <p className='relative top-20  sm:relative text-center text-sm    sm:top-20  '>Simply browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</p>
      </section>
