  ...
  return (
    <div className='ms-4 sm:-ms-0'>
      <section className=' relative top-16 sm:relative left-8 sm:top-4'>
       ...
       <section id='Speciality' className=' overflo relative top-12 left-60 flex justify-center sm:flex sm:relative sm:-left-1 gap-5 sm:justify-center mt-20 text-center'>
