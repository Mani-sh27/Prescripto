  ...
  return (
    <div>
      <section className=' relative top-16 sm:relative left-8 sm:top-4'>
          ...
          <p className='relative top-20 text-center sm:relative sm:text-center text-sm mt- sm:top-20  '>Simply browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</p>
      </section>
