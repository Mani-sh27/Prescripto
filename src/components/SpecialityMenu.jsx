  ...
  return (
    <div>
      <section className='relative'>
          ...
          <p className='sm:absolute text-center left-[4] top-20  '>Simply browse through our extensive list of trusted doctors,<br />schedule your appointment hassle-free.</p>
      </section>
